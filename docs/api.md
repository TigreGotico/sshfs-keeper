...
- `event: <event_type>`: for example `mount_healthy`, `mount_error`
...
| `remote` | string | yes | none |
| `local` | string | yes | none |
...
---
[← Configuration](configuration.md) · [Home](index.md) · [Architecture →](architecture.md)
